...
{
    /// <summary>AssetBundle打包策略</summary>
    public enum emAssetBundleNameRule
    {
        /// <summary>无</summary>
        None = 0,
        /// <summary>资源单独打包---AssetBundleName为文件资源路径</summary>
        SingleFile = 1,
        /// <summary>文件夹打包</summary>
        Folder = 2,
        /// <summary>忽略文件或者文件夹</summary>
        Ignore = 3,
    }
    /// <summary>AssetBundle编辑器环境下相关定义</summary>
    public static class EditorCommon
    {
        ...
        /// <summary>编辑器环镜下主Manifest保存路径</summary>
        public static readonly string MAIN_MANIFEST_FILE_PATH = BUILD_PATH + "/" + Common.MAIN_MANIFEST_FILE_NAME;

        /// <summary>编辑器环镜下ResourcesManifest保存路径</summary>
        public static readonly string RESOURCES_MANIFEST_FILE_PATH = BUILD_PATH + "/" + Common.RESOURCES_MANIFEST_FILE_NAME;

        /// <summary>编辑器环镜下ResourcesPackage保存路径</summary>
        public static readonly string RESOURCES_PACKAGE_FILE_PATH = BUILD_PATH + "/" + Common.RESOURCES_PACKAGE_FILE_NAME;

        /// <summary>忽略的文件类型(后缀名)</summary>
        public static readonly string[] IGNORE_FILE_EXTENSION_ARRAY = { ".rule", ".cs", ".js", ".meta", ".svn", };

        /// <summary>忽略的文件夹</summary>
        public static readonly string[] IGNORE_FOLDER_ARRAY = { ".svn", ".git" };

        /// <summary>ProjectDirectory</summary>
        ...
        /// <summary>Unity/Assets相对路径转换为绝对路径</summary>
        public static string RelativeToAbsolutePath(string path)
        {
            return ProjectDirectory + path;
        }

        /// <summary>绝对路径转换为Unity/Assets相对路径</summary>
        ...
        /// <summary>得到合适的AssetBundleName</summary>
