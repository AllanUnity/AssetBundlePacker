...
{
    /// <summary>AssetBundle下载器</summary>
    public class AssetBundleDownloader
    {
        /// <summary>并发下载最大数量----如果需要>2，则需修改System.Net.ServicePointManager.DefaultConnectionLimit</summary>
        public const int CONCURRENCE_DOWNLOAD_NUMBER = 2;

        /// <summary>URL</summary>
        public string URL;

        /// <summary>下载根路径</summary>
        public string Root;
        ...
        /// <summary>锁对象，用于保证多线程下载安全</summary>
        readonly object lock_obj_ = new object();

        /// <summary>下载资源</summary>
        public AssetBundleDownloader(string url, int concurrence_download_number = CONCURRENCE_DOWNLOAD_NUMBER)
        {
            URL = url;
            IsDone = false;
        ...
        public bool Start(string root, string assetbundlename, ResourcesManifest resources_manifest)
        {
        ...
        /// <summary>开始下载</summary>
        public bool Start(string root, List<string> assetbundles, ResourcesManifest resources_manifest)
        {
            Abort();
