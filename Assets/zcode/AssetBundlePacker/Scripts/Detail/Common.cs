...
{
    /// <summary>AssetBundle相关公共定义</summary>
    public static class Common
    {
        ...
        /// <summary>配置存在检查（如果为true，必须存在）</summary>
        ...
        /// <summary>载入ResourcesMnifest</summary>
        ...
        /// <summary>载入ResourcesPack</summary>
        ...
        public static AssetBundleManifest LoadMainManifestByPath(string full_name)
        {
            ...
            AssetBundle mainfest_bundle = AssetBundle.LoadFromFile(full_name);
        ...
        /// <summary>载入ResourcesManifest</summary>
        ...
        /// <summary>计算Transform的层次路径</summary>
